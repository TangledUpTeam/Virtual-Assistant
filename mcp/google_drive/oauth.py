"""
Google OAuth 핸들러 (Google Drive용)
"""
...
class GoogleOAuth:
    ...
    # Google Drive 및 Gmail에 필요한 scope
    SCOPES = [
    ...
    def __init__(self, client_secrets_file: Optional[str] = None):
        ...
        if client_secrets_file is None:
            # 기본 경로: mcp/google_drive/client_secrets.json
    ...
    def get_credentials(self, user_id: str, service: str = "google_drive") -> Optional[Credentials]:
        """
    ...
    def revoke_token(self, user_id: str, service: str = "google_drive") -> bool:
        """
        토큰 취소 및 삭제

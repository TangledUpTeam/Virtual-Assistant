"""
KPI 청크를 unified_documents 컬렉션에 추가

기존 KPI 자료_kpi_chunks.json 파일을 읽어서
unified_documents 컬렉션에 doc_type=kpi로 추가합니다.
...
def main():
    print("=" * 80)
    print("📊 KPI 데이터 → unified_documents 컬렉션 추가")
    print("=" * 80)
    print()
    ...
    # 4. unified_documents 컬렉션에 업로드
    print("=" * 80)
    print("⏳ unified_documents 컬렉션에 업로드 중...")
    print("=" * 80)
    
    chroma = get_chroma_service()
    collection = chroma.get_or_create_collection('unified_documents')
    
    print(f"✅ 컬렉션 'unified_documents' 연결 완료")

...
class QueryIntent(BaseModel):
    """쿼리 의도 분석 결과"""
    intent: Literal["daily", "weekly", "monthly", "performance", "kpi", "template", "mixed", "unknown"] = Field(
        ...,
        description="질의 의도"
    )
...
4. **performance** (실적 보고서)
   - 분기별 실적, 성과를 묻는 질문
   - 예: "3분기 실적 보고서 보여줘", "올해 실적 어떻게 되나요?"

5. **kpi**
   - KPI, 지표, 목표, 달성률, 실적, 성과, 합계, 평균 등을 묻는 질문
   - 숫자나 통계 데이터를 요청하는 질문
   - 예: "암보험 실적 KPI 정리해줘", "신규 계약 KPI 달성률 알려줘", "상담 건수 알려줘"

6. **template**
   - 양식, 템플릿, 서식, 폼, 예시 문서를 묻는 질문
   - 예: "월간 업무 보고서 양식 보여줘", "실적 보고서 템플릿 알려줘"
...
{
  "intent": "daily|weekly|monthly|performance|kpi|template|mixed|unknown",
  "reason": "판단 근거 설명",
  "filters": {
    "owner": "작성자 (선택)",

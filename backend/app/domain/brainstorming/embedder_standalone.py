"""
브레인스토밍 청크 임베딩 독립 실행 스크립트

이 스크립트는 .env 파일에서 직접 설정을 읽어서 실행됩니다.
의존성: openai, python-dotenv만 필요
"""
import json
import os
...
if __name__ == "__main__":
    try:
        ...
        print("   2. parsed_chunks.json 파일이 존재하는지 확인")
        print("   3. OpenAI API 잔액이 충분한지 확인")

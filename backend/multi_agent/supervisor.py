...
3. **brainstorming_tool**: 창의적 아이디어, 브레인스토밍
   - 키워드: 아이디어, 브레인스토밍, 창의적, 혁신, 발상, 생각, 방법, 전략, 기획, 제안, 개선, 새로운, 참신한, 독창적, 문제 해결, 해결책, 대안, 접근법, 마케팅, 프로젝트, 기법, 도출
   - 예시: "새로운 마케팅 아이디어를 내고 싶어", "문제 해결 방법 제안해줘", "창의적 사고 기법 알려줘"
...
**에이전트 선택 가이드:**
1. 질문에 포함된 키워드를 먼저 확인하세요.
2. 여러 에이전트의 키워드가 겹치면, 질문의 주요 목적을 파악하세요.
3. 감정적 표현(힘들어, 우울해 등)이 있으면 therapy_tool을 우선 고려하세요.
4. 회사/업무 관련 정보 요청은 rag_tool을 사용하세요.
5. 일반적인 인사나 잡담은 chatbot_tool을 사용하세요.
